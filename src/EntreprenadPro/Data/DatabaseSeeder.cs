...
public class DatabaseSeeder
{
    public DatabaseSeeder()
    {
        ...
        WorkTypes = GenerateWorkTypes(10);
        Projects = GenerateProjects(20, Customers);
        TimeEntries = GenerateTimeEntries(300, Employees, Projects, WorkTypes);
    }
    ...
    private List<Employee> GenerateEmployees(int amount)
    {
        List<string> jobTitles =
            ["Software Engineer", "Designer", "Administrator", "Manager", "IT-Support", "IT-Technician"];
    ...
    private List<TimeEntry> GenerateTimeEntries(int amount, List<Employee> employees, List<Project> projects,
        List<WorkType> workTypes)
    {
        var timeEntryFaker = new Faker<TimeEntry>()
            ...
            .RuleFor(t => t.Date,
                f => DateOnly.FromDateTime(f.Date.Between(DateTime.Now.AddDays(-2), DateTime.Now.AddDays(7))))
